...
/**
 * This class is an implementation of {@link Connector}, which is used to connect to a PostgreSQL database.
 * <p>
 * PostgreSQL is a relational database, which is used to store data in a database. This connector is used to
 * connect to a PostgreSQL database. The only thing you need to provide is the credentials to the database.
 *
...
public class PostgreSQLConnector implements Connector {
	...
	/**
	 * Create a new instance of {@link PostgreSQLConnector}. This connector
	 * is used to connect to a PostgreSQL database. The only thing you need
	 ...
	 */
	@Contract(pure = true)
	public PostgreSQLConnector(@NonNull Credentials credentials, @Nullable Properties properties) {
	 ...
	 */
	@Contract(pure = true)
	public PostgreSQLConnector(@NonNull Credentials credentials) {
	...
	public Connection connect() throws SQLException, SQLDriverException {
		try {
			...
			throw new SQLDriverException("Driver for PostgreSQL is missing.", e);
		}
	}
